...
module.exports = function(app){
    ...
    function is_api_call(req){
        ...
        if(host == app.njax.config.api.host || host == app.njax.config.core.api.host){
            return true;
        }
    ...
    function middleware(req, res, next){
        ...
        res.render = function(tpl, data){
            ...
            for(var i in app.njax.config.tpl_dirs){
                console.log("TPL:", path.join(app.njax.config.tpl_dirs[i], tpl + '.hjs'));
        ...
        var api_url = app.njax.config.api.host;

        res.bootstrap('api_url', (app.njax.config.api.protocol || req.njax.protocol) + '://' + api_url);
        res.bootstrap('www_url',(app.njax.config.api.protocol || req.njax.protocol) + '://' + www_url);
